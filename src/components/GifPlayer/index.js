/**
 * Copyright (c) 2016 Ben Wiley
 * https://github.com/benwiley4000/react-gif-player
 *
...
import {polyfill as lifestylesPolyfills} from 'react-lifecycles-compat';
...
class GifPlayerContainer extends React.Component {
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    return {
      playing:
        nextGif && nextProps.autoplay && prevGif !== nextGif
          ? true
          : prevState.playing,
      providedGif: nextGif,
      ...
      actualGif: nextGif,
      actualStill:
        nextStill || prevGif !== nextGif ? nextStill : prevState.actualStill
    };
  }
...
lifestylesPolyfills(GifPlayerContainer);
