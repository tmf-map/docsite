...
当可以渲染的 UI 还没准备好时，Suspense 可以使其显示为 Loading 状态。React 之前只支持[React.lazy 的 Suspense](/docs/react/3.optimization/3.6.suspense)。在 Concurrent 模式中，支持 Suspense 用于数据获取。
