...
链表和数组都属于基础的数据结构--线性表。为什么需要链表呢？链表存储数据时，在内存中不一定按照顺序存储，因此能充分利用计算机内存空间。但也同时失去了随机读取的优点。在实现时，需要增加一个指针域，用于存放下一个元素的地址。

<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/llinkedlist-and-array.png' alt='llinkedlist-and-array' width='600'/>
...
<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/single-list.png' alt='single-list' width='600'/>
...
<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/delete-insert-single-list.png' alt='delete-insert-single-list' width='600'/>
...
<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/circular-list.png' alt='circular-list' width='600'/>
...
<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/doubly-linked-list.png' alt='doubly-linked-list' width='600'/>

单链表只有一个方向，双向链表，顾名思义，支持两个方向。双向链表中，每一个结点不止一个后继指针 next，还有一个前驱指针 prev。

### 双向循环链表

<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/doubly-circular-list.png' alt='doubly-circular-list' width='600'/>

### 链表和数组的性能对比

<Img src='https://cosmos-x.oss-cn-hangzhou.aliyuncs.com/array-and-list.png' alt='array-and-list' width='600'/>
